...
for($i = 0; $i < count($files); $i++) {
    copy('images'.DIRECTORY_SEPARATOR.$user_id.DIRECTORY_SEPARATOR.$files[$i], 'images'.DIRECTORY_SEPARATOR.$user_id.DIRECTORY_SEPARATOR.'results'.DIRECTORY_SEPARATOR.$files[$i]); 
}

echo "Test job done <br />";
